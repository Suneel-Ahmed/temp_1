...
const Hero = () => {
  ...
  return (
    ...
    <p ref={paragraph} className='text-white opacity-0 text-center max-lg:w-[90%]  w-[60%] z-10 text-[clamp(16px,3vw,30px)]' >En tant que technicien monteur je suis capable de prendre en charge 
